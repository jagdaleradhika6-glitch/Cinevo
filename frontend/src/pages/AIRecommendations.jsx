...
import { getARecommendation } from "../lib/AIModel";
...
const AIRecommendations = () => {
  ...
  const generateRecommendations = async () => {
    ...
    const userPrompt = `Recommend 5 movies based on:
...
["Movie 1","Movie 2","Movie 3","Movie 4","Movie 5"]`;
    ...
    try {
      const result = await getARecommendation(userPrompt);
      ...
      try {
        ...
        if (!Array.isArray(recommendationArray)) {
          toast.error("Invalid recommendation response.");
          return;
        }
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#181818] via-[#232323] to-[#181818] relative overflow-hidden">
      ...
      {recommendation.length > 0 ? (
        <div className="relative w-full max-w-7xl mx-auto mt-2 px-4">
          ...
          <div className="w-full flex flex-col flex-1">
            ...
            <div className="flex justify-between items-center mt-6">
              <button
                ...
                onClick={handleBack}
                disabled={step === 0}
                className="px-6 py-2 rounded-lg font-semibold transition border-2 border-[#444] text-white bg-[#181818] hover:bg-[#232323] disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Back
              </button>
              ...
              <button
                ...
                className="px-6 py-2 rounded-lg font-semibold transition border-2 border-[#e50914] text-white bg-[#e50914] hover:bg-[#b0060f] ml-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading
                  ? "Generating..."
                  : step === steps.length - 1
